...
country_name_map = {
    ...
    '莱索托': 'Lesotho',
    '肯尼亚': 'Kenya', '白俄罗斯': 'Belarus', '塔吉克斯坦': 'Tajikistan',
    '土耳其': 'Turkey', '阿富汗': 'Afghanistan', '孟加拉国': 'Bangladesh', '毛里塔尼亚': 'Mauritania', '朝鲜': 'Dem. Rep. Korea',
    '圣卢西亚': 'Saint Lucia', '英属印度洋领地': 'Br. Indian Ocean Ter.', '蒙古': 'Mongolia', '法国': 'France',
    '库拉索岛': 'Cura?ao', '南苏丹': 'S. Sudan', '卢旺达': 'Rwanda', '斯洛伐克': 'Slovakia', '索马里': 'Somalia', '秘鲁': 'Peru',
    '瓦努阿图': 'Vanuatu', '挪威': 'Norway', '马拉维': 'Malawi', '贝宁': 'Benin', '圣文森特和格林纳丁斯': 'St. Vin. and Gren.',
    '韩国': 'Korea', '新加坡': 'Singapore', '黑山共和国': 'Montenegro', '开曼群岛': 'Cayman Is.', '多哥': 'Togo', '中国': 'China',
    '赫德岛和麦克唐纳群岛': 'Heard I. and McDonald Is.', '亚美尼亚': 'Armenia', '马尔维纳斯群岛（福克兰）': 'Falkland Is.',
    '乌克兰': 'Ukraine', '加纳': 'Ghana', '汤加': 'Tonga', '芬兰': 'Finland', '利比亚': 'Libya', '多米尼加': 'Dominican Rep.',
    '印度尼西亚': 'Indonesia', '毛里求斯': 'Mauritius', '赤道几内亚': 'Eq. Guinea', '瑞典': 'Sweden', '越南': 'Vietnam',
    '马里': 'Mali', '俄罗斯': 'Russia', '保加利亚': 'Bulgaria', '美国': 'United States', '罗马尼亚': 'Romania', '安哥拉': 'Angola',
    '乍得': 'Chad', '南非': 'South Africa', '斐济': 'Fiji', '列支敦士登': 'Liechtenstein', '马来西亚': 'Malaysia',
    '奥地利': 'Austria', '莫桑比克': 'Mozambique', '乌干达': 'Uganda', '日本': 'Japan', '尼日尔': 'Niger', '巴西': 'Brazil',
    '科威特': 'Kuwait', '巴拿马': 'Panama', '圭亚那': 'Guyana', '马达加斯加': 'Madagascar', '卢森堡': 'Luxembourg',
    '美属萨摩亚': 'American Samoa', '安道尔': 'Andorra', '爱尔兰': 'Ireland', '意大利': 'Italy', '尼日利亚': 'Nigeria',
    '特克斯和凯科斯群岛': 'Turks and Caicos Is.', '厄瓜多尔': 'Ecuador', '美属维尔京群岛': 'U.S. Virgin Is.', '文莱': 'Brunei',
    '澳大利亚': 'Australia', '伊朗': 'Iran', '阿尔及利亚': 'Algeria', '萨尔瓦多': 'El Salvador', '科特迪瓦': "Côte d'Ivoire",
    '智利': 'Chile', '波多黎各': 'Puerto Rico', '比利时': 'Belgium', '泰国': 'Thailand', '海地': 'Haiti', '伊拉克': 'Iraq',
    '圣多美和普林西比': 'S?o Tomé and Principe', '塞拉利昂': 'Sierra Leone', '格鲁吉亚': 'Georgia', '丹麦': 'Denmark',
    '菲律宾': 'Philippines', '南乔治亚岛和南桑威奇群岛': 'S. Geo. and S. Sandw. Is.', '摩尔多瓦': 'Moldova', '摩洛哥': 'Morocco',
    '纳米比亚': 'Namibia', '马耳他': 'Malta', '几内亚比绍': 'Guinea-Bissau', '基里巴斯': 'Kiribati', '瑞士': 'Switzerland',
    '格林纳达': 'Grenada', '塞舌尔': 'Seychelles', '葡萄牙': 'Portugal', '爱沙尼亚': 'Estonia', '乌拉圭': 'Uruguay',
    '安提瓜和巴布达': 'Antigua and Barb.', '黎巴嫩': 'Lebanon', '乌兹别克斯坦': 'Uzbekistan', '突尼斯': 'Tunisia', '吉布提': 'Djibouti',
    '格陵兰': 'Greenland', '东帝汶': 'Timor-Leste', '多米尼克': 'Dominica', '哥伦比亚': 'Colombia', '布隆迪': 'Burundi',
    '波黑': 'Bosnia and Herz.', '塞浦路斯': 'Cyprus', '巴巴多斯': 'Barbados', '卡塔尔': 'Qatar', '帕劳': 'Palau',
    '不丹': 'Bhutan', '苏丹': 'Sudan', '尼泊尔': 'Nepal', '密克罗尼西亚': 'Micronesia', '百慕大': 'Bermuda', '苏里南': 'Suriname',
    '委内瑞拉': 'Venezuela', '以色列': 'Israel', '圣皮埃尔和密克隆群岛': 'St. Pierre and Miquelon', '中非共和国': 'Central African Rep.',
    '冰岛': 'Iceland',
    '赞比亚共和国': 'Zambia',
    '塞内加尔': 'Senegal',
